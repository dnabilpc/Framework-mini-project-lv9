...
@section('content')
    <div class="container mb-5">
        ...
        <div class="card p-3 mx-auto">
            <h1 class="card-title text-center mb-3">Edit Biodata </h1>
                ...
                <div class="row mb-2">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('nim') is-invalid  @enderror" id="exampleInputNIM"
                            aria-describedby="NIMHelp" name="nim" value="{{ $student['nim'] }}">
                        @error('nim')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid  @enderror"
                            id="exampleInputName" aria-describedby="NameHelp" name="name" value="{{ $student['name'] }}">
                        @error('name')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row mb-2">
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('major') is-invalid  @enderror" id="exampleInputMajor"
                            ...
                            <option value="Teknik Informatika"
                                {{ $student['major'] == 'Teknik Informatika' ? 'selected' : '' }}>Teknik Informatika
                            </option>
                            <option value="Teknik Elektro" {{ $student['major'] == 'Teknik Elektro' ? 'selected' : '' }}>
                                Teknik Elektro</option>
                            <option value="Teknik Industri" {{ $student['major'] == 'Teknik Industri' ? 'selected' : '' }}>
                                Teknik Industri</option>
                            <option value="Teknik Mesin" {{ $student['major'] == 'Teknik Mesin' ? 'selected' : '' }}>Teknik
                                Mesin</option>
                            <option value="Teknik Sipil" {{ $student['major'] == 'Teknik Sipil' ? 'selected' : '' }}>Teknik
                                Sipil</option>
                            <option value="Rekaya Perangkat Lunak"
                                {{ $student['major'] == 'Rekayasa Perangkat Lunak' ? 'selected' : '' }}>Rekayasa Perangkat
                                Lunak</option>
                        </select>
                    </div>
                    @error('major')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('email') is-invalid  @enderror"
                            id="exampleInputEmail" aria-describedby="EmailHelp" name="email" value="{{ $student['email'] }}">
                        @error('email')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
